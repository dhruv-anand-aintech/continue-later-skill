...
Env: `CONTINUE_LATER_AGENT`, `CONTINUE_LATER_LIMIT`, `CONTINUE_LATER_FROM_CWD`, `CONTINUE_LATER_SKIP_TRANSCRIPT`, `CONTINUE_LATER_CLI_DIR`, `CONTINUE_LATER_BIN_DIR` (installer). **`CONTINUE_LATER_CURSOR_HOOK=0`**, **`CONTINUE_LATER_CODEX_HOOK=0`**, and **`CONTINUE_LATER_GEMINI_HOOK=0`** skip registering the optional hooks during install.
